...
module.exports.importItems = function(user, options, done) {
  ...
  // if (user.twitterNewestTweetId && options.getLatestLikes) {
  //
  // }
  if (user.twitterOldestTweetId && options.getPreviousLikes) {
  ...
  console.log(user.twitterOldestTweetId, options.getPreviousLikes);
