...
module.exports.importItems = function(user, options, done) {
  ...
  client.get('favorites/list', params, function(error, tweets, response) {
    ...
    setUserTweetIds(error, user, options, tweets, newestTweetId, oldestTweetId, done);
...
function setUserTweetIds(error, user, options, tweets, newestTweetId, oldestTweetId, done) {
  if (error) {
    return done(error);
  }
  if (options.getPreviousLikes === 'true') {
