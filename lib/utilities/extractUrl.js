...
module.exports = {
  ...
  saveMetaImage: function(imageUrl, itemId) {
  ...
  takeWebshot: function(url, itemId) {
  ...
  resizeImage: function(folder, filename, width, suffix) {
  ...
  uploadImageToS3: function(folder, filename) {
    const s3 = new AWS.S3();
    let uploadFolder;
